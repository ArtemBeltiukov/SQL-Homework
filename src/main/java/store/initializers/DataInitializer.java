...
//        orders.add(new Order(users.get(0).getId(), counteragentList.get(0).getId(), nomenclatures));
//        orders.add(new Order(users.get(1).getId(), counteragentList.get(1).getId(), nomenclatures));
